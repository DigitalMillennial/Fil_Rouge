...
','id_categorie' => '10','active' => 'Yes'),
  array('id' => '19','libelle' => 'Olivie','description' => 'Olivier salad is a traditional Russian potato salad ','prix' => '5.25','image' => '6745db46063f9.png','id_categorie' => '13','active' => 'Yes')
);

/* `restaurant`.`utilisateur` */
$utilisateur = array(
);
